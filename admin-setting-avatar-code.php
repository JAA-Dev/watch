...
if (isset($_POST['submit'])) {
    ...
    if ($_FILES['file']['error'] != 4) { // Error code 4 means no file was uploaded
        ...
        $query = "UPDATE admin_info SET Admin_Img='$img_des' WHERE Admin_ID='1'";
    ...
    // $query1 = "UPDATE admin_info SET Admin_FName='$Fname' WHERE Admin_ID='1'";
    // mysqli_query($con, $query1);

    echo "<script> alert('Save changes Successfully!');
                    location.href='admin-setting-avatar.php';</script>";
}
}
